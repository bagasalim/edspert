...
const Cards = (
  ...
  <div className="flex flex-col px-10 py-12 max-w-[462px] md:mr-10 sm:mr-5 mr-0 my-5 ">
    <div className="flex flex-row bg-blue py-4 px-3 blue-card">
      <img
        src={person}
        alt="person"
        className="w-[80px] h-[150px] items-center "
      />
